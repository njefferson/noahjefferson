...
const PAGES = [
  ...
  { file: 'public/accessibility.html',
    ...
    nonText:  [] },
  { file: 'public/planning-vocabularies.html',
    // The first essay (2026-08-31), generated by `essay.mjs` from
    // `essays/planning-vocabularies.md`. It joins this list in the SAME commit
    // that creates it — a deployed page nothing measures is the defect this
    // registry exists for, and `accessibility.html` above went unscanned by
    // anything for months before somebody counted.
    // ONLY WHAT THIS PAGE ACTUALLY RENDERS. A selector matching nothing is a
